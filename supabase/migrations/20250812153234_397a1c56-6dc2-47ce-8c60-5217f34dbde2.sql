...
-- Update get_current_month_usage function to include spotify_plays
...
-- Update increment_usage function to include spotify_plays
CREATE OR REPLACE FUNCTION public.increment_usage(p_user_id uuid, p_voice_interactions integer DEFAULT 0, p_automations integer DEFAULT 0, p_documents integer DEFAULT 0, p_spotify_plays integer DEFAULT 0)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
